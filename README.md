...
Automating car rental requests using ServiceNow **Service Catalog** and **Flow Designer** ⚙️
...
- 🗂️ Keep every request in one place so it can be tracked and audited
...
3. ⚙️ A flow starts automatically and asks the manager for approval.
...
### 1️⃣ Front end: what the user sees 🖥️
...
| ⏱️ Duration | Numeric Scale |
| 🚘 Car Type | Select Box (Mini, SUV, Sedan) |
| 💬 Reason | Multi Line Text |

### 2️⃣ Automation: what runs in the background ⚙️
...
- ☁️ A ServiceNow instance with admin access
- 🛒 Service Catalog
- 🔀 Flow Designer
